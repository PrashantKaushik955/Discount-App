...
document.getElementById("signupForm")?.addEventListener("submit", async (event) => {
  ...
  try {
    const response = await fetch("http://15.206.127.9:9000/api/v1/user/register", {
      method: "POST",
...
document.getElementById("loginForm")?.addEventListener("submit", async (event) => {
  ...
  try {
    const response = await fetch("http://15.206.127.9:9000/api/v1/user/login", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
document.getElementById("otpForm")?.addEventListener("submit", async (event) => {
  ...
  try {
    const response = await fetch("http://15.206.127.9:9000/api/v1/user/verify-otp", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
document.getElementById("resendOTP")?.addEventListener("click", async () => {
  ...
  try {
    const response = await fetch("http://15.206.127.9:9000/api/v1/user/resend-otp", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
